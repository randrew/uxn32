...
"C:\Program Files\PellesC\Bin\pocc.exe" -std:C99 -Tx86-coff -MT -Os -Ox -Ob1 -fp:precise -W0 -Gz -Ze -DNDEBUG -DWIN32 -D_WINDOWS -D_MBCS -D_WIN32_WINNT=0x0400 -DSINGULAR_MODE=1 "uxn_core.c" -Fo"build\uxn_core.obj"
"C:\Program Files\PellesC\Bin\pocc.exe" -std:C99 -Tx86-coff -MT -Os -Ox -Ob1 -fp:precise -W0 -Gz -Ze -DNDEBUG -DWIN32 -D_WINDOWS -D_MBCS -D_WIN32_WINNT=0x0400 -DSINGULAR_MODE=1 "uxn_lz.c" -Fo"build\uxn_lz.obj"
"C:\Program Files\PellesC\Bin\pocc.exe" -std:C99 -Tx86-coff -MT -Os -Ox -Ob1 -fp:precise -W0 -Gz -Ze -DNDEBUG -DWIN32 -D_WINDOWS -D_MBCS -D_WIN32_WINNT=0x0400 -DSINGULAR_MODE=1 "uxn32.c" -Fo"build\uxn32.obj"
